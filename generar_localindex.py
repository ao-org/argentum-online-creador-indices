...
def main():
    ...
    INCLUIR_CLAVES_POR_SECCION = {
        "NPC": [
            "Name", "Desc",  "Body", "BodyIdle", "Ataque1","BodyOnLand","BodyOnWater","Ataque2", "Head","DescClose",
        ...
        "OBJ": [
            "Name", "GrhIndex", "ObjType", "Agarrable", "Texto", "Llave", "Valor", "MaxDef", "MinDef", "MinHit", "MaxHit",
